...
REIMPLEMENTED = {
    ...
    "_ZN25LogicDiamondsAddedCommand7executeEP13LogicHomeModeib",
    "_ZNK17LogicClientAvatar11getDiamondsEv",
    "_ZN17LogicClientAvatar11setDiamondsEi",
    "_ZNK17LogicClientAvatar15getFreeDiamondsEv",
    "_ZN17LogicClientAvatar15setFreeDiamondsEi",
    "_ZN17LogicClientAvatar30addCumulativePurchasedDiamondsEi",
    "_ZNK13LogicHomeMode15getPlayerAvatarEv",
    "_ZN8Debugger5errorEPKc",
    "_ZN8Debugger7warningEPKc",
    "_ZN28LogicChangeAvatarNameCommand7executeEP13LogicHomeModeib",
    "_ZN17LogicClientAvatar11useDiamondsEiP15LogicClientHome",
    "_ZNK17LogicClientAvatar16getNameSetByUserEv",
    "_ZN17LogicClientAvatar16setNameSetByUserEb",
    "_ZNK13LogicHomeMode7getHomeEv",
    "_ZNK13DisplayObject4getXEv",
    "_ZN13DisplayObject4setXEf",
    "_ZNK13DisplayObject4getYEv",
    "_ZN13DisplayObject5setXYEff",
    "_ZNK13DisplayObject9getScaleXEv",
    "_ZN13DisplayObject9setScaleXEf",
    "_ZNK13DisplayObject9getScaleYEv",
    "_ZN13DisplayObject9setScaleYEf",
    "_ZN13DisplayObject8setScaleEf",
    "_ZN13DisplayObjectC2Ev",
    "_ZN30LogicDeleteNotificationCommand7executeEP13LogicHomeModeib",
    "_ZN15LogicClientHome18removeNotificationEi",
    "_ZN13DisplayObject19setVisibleRecursiveEb",
    "_ZNK17LogicClientAvatar17getCommodityCountEiPK9LogicData",
    "_ZN17LogicClientAvatar17setCommodityCountEiPK9LogicDatai",
    "_ZN17LogicClientAvatar26commodityCountChangeHelperEiPK9LogicDataiibi",
    "_ZN6Sprite8addChildEP13DisplayObject",
    "_ZN6Sprite10addChildAtEP13DisplayObjecti",
    "_ZN6Sprite13removeChildAtEi",
    "_ZN6Sprite11removeChildEP13DisplayObject",
    "_ZN6Sprite17removeAllChildrenEv",
    "_ZNK6Sprite16getChildrenArrayEv",
    "_ZNK17LogicClientAvatar12getHeroLevelEPK18LogicCharacterData",
    "_ZN17LogicClientAvatar12setHeroLevelEPK18LogicCharacterDatai",
    "_ZN13LogicConfData14getLevelUpCostEi",
    "_ZNK13DisplayObject9isChildOfEPK6Sprite",
    "_ZNK9MovieClip14getNameOfChildEPK13DisplayObject",
    ...
    "_ZN10GatchaDrop6doDropEP13LogicHomeModeb",
    "_ZNK13LogicConfData11getIntValueEi",
    "_ZNK13LogicConfData11getIntValueEii",
    "_ZNK13LogicConfData16getIntValueEntryEi",
    "_ZN13LogicConfData18getDefaultIntValueEi",
    "_ZN31LogicPurchaseDoubleCoinsCommand7executeEP13LogicHomeModeib",
    ...
    "_ZN15LogicJSONParser15parseJSONObjectEPK6String",
    "_ZN15LogicJSONParser10parseValueERK6StringPi",
    "_ZN15LogicJSONParser16parseStringValueERK6StringPi",
    "_ZN15LogicJSONParser18parseEscapedStringERK6StringiPi",
    "_ZN15LogicJSONParser11parseNumberERK6StringPi",
    "_ZN15LogicJSONParser12parseBooleanERK6StringPi",
    "_ZN15LogicJSONParser9parseNullERK6StringPi",
    "_ZN15LogicJSONParser10parseArrayERK6StringPi",
    "_ZN15LogicJSONParser11parseObjectERK6StringPi",
    "_ZN15LogicJSONParser11parseStringERK6StringPi",
    "_ZN15LogicJSONParser16createJSONStringEPK13LogicJSONNodei",
    "_ZN15LogicJSONParser11writeStringEPK6StringP13StringBuilder",
    "_ZNK15LogicJSONNumber13writeToStringEP13StringBuilder",
    "_ZNK16LogicJSONBoolean13writeToStringEP13StringBuilder",
    "_ZNK15LogicJSONString13writeToStringEP13StringBuilder",
    "_ZNK14LogicJSONArray13writeToStringEP13StringBuilder",
    "_ZNK15LogicJSONNull13writeToStringEP13StringBuilder",
    "_ZNK15LogicJSONObject13writeToStringEP13StringBuilder",
    "_ZN13LogicJSONNodeC2Ev",
    "_ZN15LogicJSONNumberC2Ei",
    "_ZN15LogicJSONNumberC2Ev",
    "_ZN15LogicJSONNumberC2Ex",
    "_ZN15LogicJSONNumberC2Ef",
    "_ZN14LogicJSONArrayC2Ev",
    "_ZN14LogicJSONArrayC2Ei",
    "_ZN15LogicJSONStringC2EP6String",
    "_ZN16LogicJSONBooleanC2Eb",
    "_ZN15LogicJSONObjectC2Ev",
    "_ZN15PepperEncrypter7encryptEPKcPci",
    "_ZN15PepperEncrypter7decryptEPKcPci",
    "_ZN15PepperEncrypterC2EN12PepperCrypto9SecureKeyILm32EEENS1_ILm24EEE",
    "_ZN12PepperCrypto3boxEPKvmPvmRKNS_9SecureKeyILm24EEERKNS3_ILm32EEE",
    "_ZN12PepperCrypto8box_openEPKvmPvmRKNS_9SecureKeyILm24EEERKNS3_ILm32EEE",
...
REIMPLEMENTED_EXTRA = {
    ...
    "BandNotification": ("6encodeE", "6decodeE"),
    "BoxRewardNotification": ("6encodeE", "6decodeE"),
    "BrawlPassAutoCollectSeasonNotification": ("6encodeE", "6decodeE"),
    "BrawlPassPointRewardNotification": ("6encodeE", "6decodeE"),
    "BrawlPassRewardNotification": ("6encodeE", "6decodeE"),
    "ChallengeRewardNotification": ("6encodeE", "6decodeE"),
    "ChallengeSkinRewardNotification": ("6encodeE", "6decodeE"),
    "CoinDoublerRewardNotification": ("6encodeE", "6decodeE"),
    "DonateNotification": ("6encodeE", "6decodeE"),
    "FloaterTextNotification": ("6encodeE", "6decodeE"),
    "GemRewardNotification": ("6encodeE", "6decodeE"),
    "HeroPowerRewardNotification": ("6encodeE", "6decodeE"),
    "HeroRewardNotification": ("6encodeE", "6decodeE"),
    "IAPDeliveryNotification": ("6encodeE", "6decodeE"),
    "ProLeagueSeasonEndNotification": ("6encodeE", "6decodeE"),
    "QualifyNotification": ("6encodeE", "6decodeE"),
    "RankRewardNotification": ("6encodeE", "6decodeE"),
    "RankedMidSeasonRewardNotification": ("6encodeE", "6decodeE"),
    "RankedSeasonEndNotification": ("6encodeE", "6decodeE"),
    "ResourceRewardNotification": ("6encodeE", "6decodeE"),
    "RevokeNotification": ("6encodeE", "6decodeE"),
    "ScoreEntry": ("6encodeE", "6decodeE"),
    "SkinPurchaseOptionRewardNotification": ("6encodeE", "6decodeE"),
    "SkinRewardNotification": ("6encodeE", "6decodeE"),
    "StarPointsNotification": ("6encodeE", "6decodeE"),
    "StarPointMigrationNotification": ("6encodeE", "6decodeE"),
    "StarPowerRewardNotification": ("6encodeE", "6decodeE"),
    "TicketCompensationNotification": ("6encodeE", "6decodeE"),
    "TicketRewardNotification": ("6encodeE", "6decodeE"),
    "VanityItemRewardNotification": ("6encodeE", "6decodeE"),
