...
BitStream::BitStream(i32 capacity) {
...
void BitStream::setBuffer(const u8* data, i32 len) {
...
void BitStream::writeBoolean(bool v) {
...
void BitStream::writePositiveInt(i32 v, int bits) {
...
i32 BitStream::readPositiveInt(int bits) {
    i32 v = 0;
...
void BitStream::writeInt(i32 v, int bits) {
...
void BitStream::writePositiveVInt(i32 v, int prefixBits) {
...
i32 BitStream::readPositiveVInt(int prefixBits) {
