...
Registry (compiled in): **1889 reimplemented, 9717 third-party, 25458 pending**
...
| Game code reimplemented | 1889 fns | `src/` + tests |
| Game code pending | 25458 | `FunctionRegistry` status `Pending` |
