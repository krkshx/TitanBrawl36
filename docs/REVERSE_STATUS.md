...
Registry (compiled in): **1886 reimplemented, 9717 third-party, 25461 pending**
...
| Game code reimplemented | 1886 fns | `src/` + tests |
| Game code pending | 25461 | `FunctionRegistry` status `Pending` |
