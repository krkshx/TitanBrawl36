...
Registry (compiled in): **1953 reimplemented, 9717 third-party, 25394 pending**
...
| Game code reimplemented | 1953 fns | `src/` + tests |
| Game code pending | 25394 | `FunctionRegistry` status `Pending` |
