...
Registry (compiled in): **1942 reimplemented, 9717 third-party, 25405 pending**
...
| Game code reimplemented | 1942 fns | `src/` + tests |
| Game code pending | 25405 | `FunctionRegistry` status `Pending` |
