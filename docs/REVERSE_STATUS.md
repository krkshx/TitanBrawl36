...
Registry (compiled in): **1910 reimplemented, 9717 third-party, 25437 pending**
...
| Game code reimplemented | 1910 fns | `src/` + tests |
| Game code pending | 25437 | `FunctionRegistry` status `Pending` |
